...
public class HBaseSinkConfigTest {
  ...
  private static final Schema VALID_INPUT_SCHEMA = Schema.recordOf(
    ...
    Schema.Field.of("family", Schema.nullableOf(Schema.of(Schema.Type.LONG)))
  );
  private static final HBaseSinkConfig VALID_CONFIG = new HBaseSinkConfig(
    "ref",
    "",
    "id",
    "family",
  ...
  public void testValidateReference() {
    HBaseSinkConfig config = HBaseSinkConfig.builder(VALID_CONFIG)
      .setReferenceName("")
      .build();
  ...
  @Test
  public void testValidatePortNegativeValue() {
    HBaseSinkConfig config = HBaseSinkConfig.builder(VALID_CONFIG)
      .setPort("-1")
      .build();
    ...
    MockFailureCollector failureCollector = new MockFailureCollector(MOCK_STAGE);
    config.validate(failureCollector, VALID_INPUT_SCHEMA);
    ValidationAssertions.assertPropertyValidationFailed(failureCollector, HBaseSinkConfig.PORT);
  }

  @Test
  public void testValidatePortOutOfRangeValue() {
    HBaseSinkConfig config = HBaseSinkConfig.builder(VALID_CONFIG)
      .setPort("65536")
      .build();
  ...
  @Test
  public void testValidatePortFormat() {
    HBaseSinkConfig config = HBaseSinkConfig.builder(VALID_CONFIG)
      .setPort("a")
      .build();
  ...
  public void testValidateMissingRowKeyInSchema() {
    ...
    MockFailureCollector failureCollector = new MockFailureCollector(MOCK_STAGE);
    config.validate(failureCollector, VALID_INPUT_SCHEMA);
    ValidationAssertions.assertPropertyValidationFailed(failureCollector, HBaseSinkConfig.ROW_KEY);
  }
  ...
  @Test
  public void testValidateMissingFamilyKeyInSchema() {
    HBaseSinkConfig config = HBaseSinkConfig.builder(VALID_CONFIG)
      .setFamily("key")
      .build();
    ...
    MockFailureCollector failureCollector = new MockFailureCollector(MOCK_STAGE);
    config.validate(failureCollector, VALID_INPUT_SCHEMA);
    ValidationAssertions.assertPropertyValidationFailed(failureCollector, HBaseSinkConfig.FAMILY);
  }

  @Test
  public void testValidateWrongFamilyKeyExpression() {
    HBaseSinkConfig config = HBaseSinkConfig.builder(VALID_CONFIG)
      .setFamily("#")
      .build();
  ...
  @Test
  public void testValidateWrongFamilyKeyType() {
    Schema inputSchema = Schema.recordOf(
      "schema",
      Schema.Field.of("id", Schema.nullableOf(Schema.of(Schema.Type.LONG))),
      Schema.Field.of("family", Schema.nullableOf(Schema.enumWith("v1")))
    );

    MockFailureCollector failureCollector = new MockFailureCollector(MOCK_STAGE);
    VALID_CONFIG.validate(failureCollector, inputSchema);
    ValidationAssertions.assertPropertyValidationFailed(failureCollector, HBaseSinkConfig.FAMILY);
    ValidationAssertions.assertInputSchemaValidationFailed(failureCollector, "family");
  }
